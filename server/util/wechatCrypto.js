...
/** * 删除解密后明文的补位字符 * * @param {String} text 解密后的明文 */
...
/** * 对需要加密的明文进行填充补位 * * @param {String} text 需要进行填充补位操作的明文 */
...
/** * 微信企业平台加解密信息构造函数 * * @param {String} token 公众平台上，开发者设置的Token * @param {String} encodingAESKey 公众平台上，开发者设置的EncodingAESKey * @param {String} id 企业号的CorpId或者AppId */
...
/** * 获取签名 * * @param {String} timestamp 时间戳 * @param {String} nonce 随机数 * @param {String} encrypt 加密后的文本 */
...
/** * 对密文进行解密 * * @param {String} text 待解密的密文 */
...
/** * 对明文进行加密 * * @param {String} text 待加密的明文 */
