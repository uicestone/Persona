(function () {
    ...
    function projectService($resource) {
        ...
        var project = $resource(api + 'project/:id', {id: '@_id'}, {
            ...
            getKpi: {method: 'GET', url: api + 'project/:id/kpi'},
            getKpiByChannels: {method: 'GET', url: api + 'project/:id/kpi-by-channels'},
    ...
    function wechatService ($http, $mdToast) {
        return {
            ...
            getQrScene: function (appId) {
                return $http.get(api + 'wechat/' + appId + '/qrscene');
            },
